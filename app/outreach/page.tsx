...
export default async function OutreachPage() {
  ...
  if (!authDisabled && !hasClerkRuntimeEnv()) {
    return <SetupState title="Outreach is waiting on auth setup" />
  }
    ...
    <div className="px-8 py-8 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-[#6b6560]">
          Outreach is intentionally secondary here. The GTM hub should decide who matters first, then this page helps the team translate that into coordinated messaging.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-2xl border border-[#e8e4dc] bg-white p-5">
          ...
          <p className="font-serif text-3xl font-light">{demoOutreachSummary.activeSequences}</p>
        </div>
        <div className="rounded-2xl border border-[#e8e4dc] bg-white p-5">
          ...
          <p className="font-serif text-3xl font-light">{demoOutreachSummary.enrolledLeads}</p>
        </div>
        <div className="rounded-2xl border border-[#e8e4dc] bg-white p-5">
          ...
          <p className="font-serif text-3xl font-light">{demoOutreachSummary.openRate}%</p>
        </div>
        <div className="rounded-2xl border border-[#e8e4dc] bg-white p-5">
          ...
          <p className="font-serif text-3xl font-light">{demoOutreachSummary.replyRate}%</p>
        </div>
      </div>
